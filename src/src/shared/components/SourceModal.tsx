      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          <div className="mb-4">
            ...
            <a
              ...
              className="flex items-center gap-1 text-primary-blue underline mt-1 hover:text-blue-700 transition-colors"
            >
        ...
        <div className="px-6 py-4 border-t border-gray-200">
          <button
            ...
            className="w-full py-3 bg-primary-blue text-white rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
          >
