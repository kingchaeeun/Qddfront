      ...
      <div className="mb-5">
        ...
        <div className="flex items-start gap-2">
          <div className="flex-1 space-y-2">
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600 text-xs">의미 축소</span>
                <span
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600 text-xs">해석 확장</span>
                <span
                  className={getScoreColor(
                    source.scores.interpretiveExtension,
                  )}
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600 text-xs">어휘 색채</span>
                <span
                  className={getScoreColor(
                    source.scores.lexicalColoring,
                  )}
          ...
          <div className="w-40 h-40 flex-shrink-0">
            <RadarChart scores={source.scores} isHighDistortion={isHighDistortion} />
          </div>
        </div>
      </div>
